...
public class Byn implements Comparable<Byn> {
    ...
    public Byn(int coinValue) throws IllegalArgumentException {
        if (coinValue < 0) {
            throw new IllegalArgumentException("Negative value in coinValue - " + coinValue);
        } else {
            this.coinValue = coinValue;
        }
    }

    public Byn(Byn byn) throws IllegalArgumentException {
        this(byn.coinValue);
    }

    public Byn(int rubs, int coin) throws IllegalArgumentException {
        this(rubs * 100 + coin);
    }
